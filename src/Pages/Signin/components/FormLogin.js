            ...
            <div className="flex-1">
                ...
                <form className="">
                    <div>
                        ...
                        <input type="text"
                            className="form-control block w-[400px] px-2 py-1 text-xl font-normal text-[rgba(56, 128, 135, 1)]-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-[10px] transition ease-in-out mb-5 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
