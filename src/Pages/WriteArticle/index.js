            ...
            <div className="mx-36 mb-16">
                <div className="flex flex-row">
                    <div className="flex flex-col justify-center ml-32">
                        <div className="w-48 h-72 bg-gray-200 outline-dashed border-[#376AED] ">
                    ...
                    <div className="flex flex-col ml-10">
                        <div className="flex flex-row">
                            <input type="text"
                                className="rounded-lg form-control border-[#376AED] h-12 block w-96 px-4 py-2 text-lg text-left font-normal text-gray-700 bg-white  border border-solid focus:border-blue-600 focus:outline-none" placeholder="Article Tittle" />
                            ...
                            {/* <input type="text"
                            className="ml-3 rounded-lg form-control border-[#376AED] h-12 block w-full px-4 py-2 text-lg text-left font-normal text-gray-700 bg-white  border border-solid focus:border-blue-600 focus:outline-none" placeholder="Article Tittle" /> */}
                        </div>
                        <div className="flex flex-row">
                            <p className="mt-5 mb-5 font-bold text-[#376AED]">Attacment  : </p>
                        ...
                        <button className="w-full mt-4 inline-block font-['Mulish'] h-12 py-2.5 text-white font-bold text-base hover:text-white leading-tight  rounded-lg shadow-md hover:bg-[#164ace] hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 bg-[#376AED] active:shadow-lg transition duration-150 ease-in-out ">
